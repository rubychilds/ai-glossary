...
<StructuredData 
  title="Epoch" 
  description="One complete pass through the entire training dataset during model training. An epoch represents a full cycle where the learning algorithm has processed every example in the training dataset once." 
  url="https://ai-glossary.com/E/epoch" 
/>
