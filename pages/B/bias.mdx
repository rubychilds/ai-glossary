...
<StructuredData
  title="Bias"
  description="Systematic errors or unfairness in AI systems that can lead to discriminatory outcomes. Bias in AI occurs when algorithms systematically favor certain groups or outcomes over others."
  url="https://ai-glossary.com/B/bias"
/>
