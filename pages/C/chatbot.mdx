...
<StructuredData
  title="Chatbot"
  description="An AI program designed to simulate conversation with human users. Chatbots use natural language processing to understand user inputs and generate appropriate responses."
  url="https://ai-glossary.com/C/chatbot"
/>
