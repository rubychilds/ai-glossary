...
<StructuredData
  title="Corpus"
  description="A large collection of texts or documents used for training language models and NLP research. In AI, a corpus serves as the fundamental training data that enables machine learning models to understand and generate human language."
  url="https://ai-glossary.com/C/corpus"
/>
...
- **[Fine-Tuning](../F/fine-tuning)** applies pre-trained models to specialized corpora for specific tasks. A general language model trained on diverse text can be adapted using domain-specific corpora for medical, legal, or technical applications.
