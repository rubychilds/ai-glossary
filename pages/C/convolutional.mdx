...
<StructuredData
  ...
  description="A type of neural network especially effective for processing grid-like data such as images. CNNs use mathematical convolution operations to detect local patterns and features through learnable filters."
  url="https://ai-glossary.com/C/convolutional"
/>
