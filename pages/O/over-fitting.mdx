...
<StructuredData 
  title="Overfitting" 
  description="When a model learns the training data too well, including noise, and performs poorly on new data. Overfitting occurs when a model becomes too complex relative to the training data, memorizing specific examples rather than learning generalizable patterns." 
  url="https://ai-glossary.com/O/over-fitting" 
/>
