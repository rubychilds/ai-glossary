...
<StructuredData 
  title="Prompt" 
  description="The input text or instruction given to an AI model to generate a desired response. A prompt serves as the starting point that guides the AI's generation of text, code, images, or other outputs." 
  url="https://ai-glossary.com/P/prompt" 
/>
