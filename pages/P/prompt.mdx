...
### Hallucination
[Hallucination](../H/halluctination) occurs when AI generates plausible-sounding but incorrect information. Prompt engineering can help mitigate this by encouraging the AI to acknowledge uncertainty and cite sources when possible.
