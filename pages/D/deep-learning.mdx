...
<StructuredData 
  title="Deep Learning" 
  description="A subset of machine learning using neural networks with multiple layers to learn complex patterns. Deep learning models can automatically discover relevant features without manual feature engineering using architectures inspired by the human brain." 
  url="https://ai-glossary.com/D/deep-learning" 
/>
