...
These models can be divided into five categories: [Convolution Neural Networks (CNN)](C/cnn.md), Restricted
Boltzmann Machines (RBM), Autoencoders, Sparse Coders, and [Recurrent Neural Networks](/Recurrent-Neural-Networks.md). 